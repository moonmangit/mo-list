<template>
  ...
  >
    <div
      class="fixed inset-x-0 bottom-0 max-h-[70dvh] rounded-b-none rounded-t-2xl bg-white p-8 duration-300 md:inset-x-auto md:bottom-auto md:w-[min(450px,90dvw)] md:rounded-b-2xl"
      :class="{
